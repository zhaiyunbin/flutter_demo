...
class MenuItemListCell extends StatelessWidget {
  MenuItemListCell({Key key,this.title,this.authorName,this.index}) : super(key: key);
  final String title;
...
//                gradient: LinearGradient(colors: [Colors.white,Colors.green]),
                image: new DecorationImage(image:new AssetImage(Images.getHomeImagePath(Images.homeTest,format:"jpeg")),fit: BoxFit.cover),
              ...
              Positioned(
                ...
                child:  new SizedBox(
                  ...
                  child: ClipRRect(
                    borderRadius: new BorderRadius.all(Radius.circular(20)),
                    child: Image.asset(Images.getHomeImagePath(Images.homeHeaderSs)),
                  ),
                ),
              ),
      ...
      onTap: (){
        Navigator.pushNamed(context, FuRouter.CollectionRoute,arguments:'menu'+'$index');
      },
    );
  }
}
